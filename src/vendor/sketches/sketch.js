...
import VMRecorder from '../../utils/vm-recorder/vm.recorder';
...
export default function sketch(p) {
	...
	p.setup = function() {
		...
		//create and setup a recorder
		recorder = new VMRecorder(canvas, width, height);
		
	};

	//function to track when song is ended
	const onSongEnd = ()=>{
		...
		//stop recorder when song is ended
		recorder.stop(blob=>{
			//save file as
			recorder.saveRecordedFile();
		});
	}
